...
\usetheme[faculty=cice]{fibeamer}
...
\title{Introducción Al Análisis De Malware} %% that will be typeset on the
\subtitle{Primeros Pasos con Malware} %% title page.
\author{Luis Gil De Berenabé Pfeiffer}
...
\begin{document}
  ...
  \AtBeginSection[]{% Print an outline at the beginning of sections
    \begin{frame}<beamer>
      \frametitle{Tabla de contenidos \thesection}
...
%%Fin del tema Oscuro Y comienzo del vainilla
